...
describe("Remove Claim Telos Arbitration Smart Contract Tests", () => {
    ...
    it("remove claim", async () => {
        ...
        await arbitration.contract.removeclaim({
            case_id: "0",
            claim_id: "0",
            claimant: "user1",
        },
        ...
        expect(casefiles.find(cf => cf.case_id === "0").number_claims).toEqual(0);  
    ...
    it("fails if case not found", async () => {
         await expect(arbitration.contract.removeclaim({
            case_id: "1",
            claim_id: "0",
            claimant: "user1",
        },
        ...
        await arbitration.loadFixtures("casefiles", {
         ...
         await expect(arbitration.contract.removeclaim({
            ...
            [{
              actor: user1.accountName,
              permission: "active"
            }])).rejects.toThrow("Claims cannot be removed after CASE_SETUP is complete");
    })
